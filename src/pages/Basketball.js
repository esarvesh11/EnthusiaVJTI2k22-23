...
function Basketball() {
    return (
        <div className="box-content mb-8 w-full">
            <h1 className="text-3xl p-2">Basketball</h1>

            <div className="flex flex-wrap text-blue-500 text-lg justify-center">
                <div>
                    <img src="https://github.com/esarvesh11/Pictures/blob/main/images/Basketball_2.jpg?raw=true" alt="Basketball poster" className="h-96 scale-125 my-28 rounded-2xl mt-48" />
                ...
                <div className="xl:ml-20 lg:ml-15 md:ml-12 mt-16">
                    ...
                    <div className="font-sans text-xl text-slate-400 mb-2 font-bold"><p>Team participation</p></div>
            ...
            <div className="flex justify-center cols-2 gap-4 ">
                <button class="bg-black hover:bg-blue-700 font-sans text-blue-500 font-semibold hover:text-white py-2 mb-4 px-4 border border-blue-500 hover:border-transparent rounded">
                    <a class="no-underline" target='_blank' href="https://docs.google.com/forms/d/e/1FAIpQLSd-CqWMw3WNKbZOndc9Sn0_Ew9Ne174SCI8ILmHsXnQOuqX7A/viewform">Link</a>
                </button>
                <button class="bg-black hover:bg-blue-700 font-sans text-blue-500 font-semibold hover:text-white py-2 mb-4 px-4 border border-blue-500 hover:border-transparent rounded">
