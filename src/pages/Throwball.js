...
function Throwball() {
    return (
       ...
       <h1 className="text-3xl p-2">Throwball</h1>
       
       <div className="flex flex-wrap text-blue-500 text-lg justify-center">
                <div>
                    <img src="https://github.com/esarvesh11/Pictures/blob/main/images/Throwball.jpg?raw=true" alt="Throwball-poster" className="h-96 scale-125 my-28 rounded-2xl" />
                ...
                <div className="xl:ml-20 lg:ml-15 md:ml-12 mt-24">
                    ...
                    <div className="font-sans text-lg text-bold text-slate-400 font-extrabold ">
                        <div className="mb-4"> <span className="text-blue-500 ">Rs 700/-</span> <span className="text-pink-700">(per Team)</span></div>
                    </div>
                    <div className="flex text-xl text-slate-200 justify-center mb-2">
                        <h2>Prize pool:</h2>
                    </div>
                    <div className="font-sans text-lg text-bold text-slate-400 mb-4 font-extrabold"><p>Winner : Rs 3000/-</p></div>
                    <div className="flex text-xl text-slate-200 justify-center mb-2">
                        <h2>Runner ups:</h2>
                    </div>
                    <div className="font-sans text-lg text-bold text-slate-400 mb-4 font-extrabold"><p>Rs 1500/-</p></div>
                </div>
       ...
       <div className="flex text-xl text-slate-200 justify-center">
        ...
        <div className="flex justify-center cols-2 gap-4 mt-2">   
            ...
            <a class="no-underline" target='_blank' href="https://docs.google.com/forms/d/e/1FAIpQLSfSBNRqLCMFvxk4SS99jjmA1ihJeCqdX-AzXr9XNYjlOvfjGQ/viewform">Link</a>
            </button>
