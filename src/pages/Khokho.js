...
function Khokho() {
    return (
       ...
       <h1 className="text-3xl p-2">Kho-Kho</h1>
       
       <div className="flex flex-wrap text-blue-500 text-lg justify-center">
                <div>
                    <img src="https://github.com/esarvesh11/Pictures/blob/main/images/Kho-kho.jpg?raw=true" alt="Kho-Kho-poster" className="h-96 scale-125 my-28 rounded-2xl mt-36" />
       ...
       <div className="flex text-xl text-slate-200 justify-center">
        ...
        <div className="flex justify-center cols-2 gap-4 mt-2">   
            ...
            <a class="no-underline" target='_blank' href="https://docs.google.com/forms/d/e/1FAIpQLSd8h3GiBP9WudSkc4XbUCx10Q793dlVNwKruRxh_02bfr-Now/viewform">Link</a>
            </button>
