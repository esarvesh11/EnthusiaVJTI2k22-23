...
function Football() {
    return (
        ...
        <h1 className="text-2xl p-2">Football</h1>
        </div>
        <div className="inline-flex">
        <div className="flex text-blue-500 text-lg justify-center">
            <div>
                    <img src="images/Football Final.jpg" alt="marathon-poster" className="h-96 scale-100 rounded-2xl" />                 
            </div>
        ...
        <div className="font-sans text-lg text-bold text-slate-400 mb-4"><p>Team participation</p>
        </div>   
        ...
        <div className="font-sans text-lg text-bold text-slate-400 mx-10 mb-4">Non-VJTIans: <span className="text-blue-500">9v9 : 3000/- , Rink(Boys) : 1600/- ,</span>
        </div>
        <div>
        <span className="text-blue-500"> Rink(Girls) : 1400/- (per Team)</span>
        </div>
        <div>
        <span className="text-pink-700">(exclusive of taxes)</span>
        </div>
        ...
        <div className="flex text-xl text-slate-200 justify-center">
            ...
            <button class="bg-transparent hover:bg-blue-700 font-sans text-blue-500 font-semibold hover:text-white py-2 mx-2 mb-4 px-4 border border-blue-500 hover:border-transparent rounded">
