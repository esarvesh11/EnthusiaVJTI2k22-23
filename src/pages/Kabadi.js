...
function Kabadi() {
    return (
       ...
       <h1 className="text-3xl p-2">Kabaddi</h1>
       
       <div className="flex flex-wrap text-blue-500 text-lg justify-center">
                <div>
                    <img src="https://github.com/esarvesh11/Pictures/blob/main/images/Kabaddi.jpg?raw=true" alt="Kabadi-poster" className="h-96 scale-125 my-28 rounded-2xl mt-36" />
                ...
                <div className="xl:ml-20 lg:ml-15 md:ml-12 mt-20">
                    ...
                    <div className="font-sans text-lg text-bold text-slate-400 mb-4 font-extrabold"><p>Boys : Rs 10,000/-</p></div>
                    <div className="font-sans text-lg text-bold text-slate-400 mb-4 font-extrabold"><p>Girls : Rs 5000/-</p></div>
                    <div className="flex text-xl text-slate-200 justify-center mb-2">
                        <h2>Runner ups:</h2>
                    </div>
       ...
       <div className="flex text-xl text-slate-200 justify-center">
        ...
        <div className="flex justify-center cols-2 gap-4 mt-2">   
            ...
            <a class="no-underline" target='_blank' href="https://docs.google.com/forms/d/e/1FAIpQLSfAUIGhWHFgf07_EFGWU7bCy79KGgGwO6XXOMsNd9RkU4shbA/viewform">Link</a>
            </button>
