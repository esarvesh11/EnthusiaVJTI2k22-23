...
function Cricket() {
    return (
        <div className="box-content mb-8 w-full">
            <h1 className="text-3xl p-2">Cricket</h1>
            ...
            <div className="flex flex-wrap text-blue-500 text-lg justify-center">
                ...
                <div className="xl:ml-20 lg:ml-15 md:ml-12 mt-24">
                    ...
                    <div className="font-sans text-lg text-bold text-slate-400 mb-4 font-extrabold"><p>Tennis : Rs 18,000 + Trophy</p></div>
                    <div className="font-sans text-lg text-bold text-slate-400 mb-4 font-extrabold"><p>Leather : Rs 24,000 + Trophy</p></div>
                </div>
            ...
            <div className="flex justify-center cols-2 gap-4 mt-2 ">
                <button class="bg-black hover:bg-blue-700 font-sans text-pink-700 font-semibold hover:text-white py-2 mb-4 px-2 border border-pink-700 hover:border-transparent rounded ">
                    <a class="no-underline" target='_blank' href="https://docs.google.com/forms/d/e/1FAIpQLSd_NM_vMhnmD98KjztrZNXmku4CoHrObEmaYEZxvYLVZTcHJg/viewform">Cricket (Leather Ball) </a>
                </button>
                <button class="bg-black hover:bg-blue-700 font-sans text-pink-700 font-semibold hover:text-white py-2 mb-4 px-2 border border-pink-700 hover:border-transparent rounded">
                    <a class="no-underline" target='_blank' href="https://docs.google.com/forms/d/e/1FAIpQLSflqqMFIVansfQEcaKPqBQK9wiuXg01aoQRUvqlQuM3xns5Pg/viewform">Cricket (Tennis Ball)</a>
                </button>
            </div>
