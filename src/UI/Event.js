...
function Event(props) {
    return(<div className="box-content mb-8 w-full">
       ...
       <div className="w-96 grid grid-cols-1 gap-8 mx-auto text-orange-100 text-lg mb-4">
       ...
       <div className="font-sans text-lg text-bold text-slate-400">{props.text1} <span className="text-orange-100">{props.vjtifee}</span></div>
       <div className="font-sans text-lg text-bold text-slate-400 mb-4">{props.text2} - <span className="text-orange-100">{props.fee}/-</span></div>
       ...
       <div className="font-sans text-lg text-bold text-slate-400 mb-4"><p>Rs. {props.prizepool}/-</p></div>  
        ...
        <div className="flex justify-center cols-2 gap-4">   
            <button class="bg-transparent hover:bg-blue-700 font-sans text-orange-300 font-semibold hover:text-white py-2 mb-4 px-4 border border-orange-300 hover:border-transparent rounded">
